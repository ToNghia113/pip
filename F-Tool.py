...
class Home:
	...
	def home(self): # don't edit this banner lol
		print(f"""
                        {DDOS TOOL
                            Made with LTN     {Color.LG}<{Color.LR}]""")
		...
		while True:
			try:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"LTN"+Color.LB+"@"+Color.LG+"H"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
				if option in ['01', '1']:
					os.system('clear')
					Tool.proxy(option)
...
""")
  ...
  \ \| '_ \ / _ \/ _ \/ _` | / /\/ _ \/ __| __|
  _\ \ |_) |  __/  __/ (_| |/ / |  __/\__ \ |_
  \__/ .__/ \___|\___|\__,_|\/   \___||___/\__| BY LTN
     |_|
...
def spoof_useragents():
	...
	'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.5110.116 Safari/537.36'
	'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.5054.159 Safari/537.36'
	'Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.5112.131 Safari/537.36'
	'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5065.80 Safari/537.36'
 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5088.122 Safari/537.36'	]
